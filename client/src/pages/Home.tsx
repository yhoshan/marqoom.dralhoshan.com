...
const CATEGORIES = [
  { id: "all", label: "الكل", count: 85 },
  { id: "حديث", label: "الحديث وعلومه", count: 26 },
  { id: "قرآن", label: "علوم القرآن والقراءات", count: 3 },
  { id: "فقه", label: "الفقه المقارن", count: 14 },
  { id: "تفسير", label: "التفسير", count: 14 },
  { id: "عقيدة", label: "العقيدة والأصول", count: 14 },
  { id: "أصول", label: "الأصول والمنطق", count: 6 },
  { id: "لغة", label: "اللغة والبلاغة", count: 4 },
