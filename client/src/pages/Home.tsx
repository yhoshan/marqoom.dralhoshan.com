...
const KASHAFAT = [
...

  {
    ...
    stats: [
      { label: "عبارة", value: "93,192" },
      { label: "مورد", value: "43,759" },
      { label: "علم", value: "26,035" },
      { label: "جزءاً", value: "32" },
    ],
    tag: "تفسير موسوعي جدلي",
    url: "https://marqoom4.dralhoshan.com",
    xlsxUrl: "/manus-storage/alrazi_997c4d70.xlsx",
  },
  {
    id: "alqurtubi",
    num: 5,
    ...
    xlsxUrl: "/manus-storage/alqurtubi_cbbd5fd0.xlsx",
  },
  {
    id: "altabari",
    num: 6,
    ...
    categoryLabel: "التفسير",
    description:
      "فهرس تحليلي لجامع البيان في تأويل القرآن — أقدم التفاسير الكبرى وأوسعها في نقل أقوال السلف والروايات، يرصد 114 سورة بـ 48,568 وحدة داخلية وكثافة أسانيد 12.6 لكل 1000 كلمة.",
    stats: [
      { label: "كلمة", value: "3 مليون" },
      { label: "وحدة", value: "48,568" },
      { label: "سورة", value: "114" },
      { label: "إسناد/ألف", value: "12.6" },
    ],
    tag: "تفسير بالمأثور",
  ...
  },
  {
    ...
    stats: [
      { label: "كلمة", value: "2.8 مليون" },
      { label: "مورد", value: "80,090" },
      { label: "علم", value: "57,800" },
      { label: "كتاباً", value: "44" },
    ],
    tag: "فقه شافعي موسوعي",
    url: "https://marqoom7.dralhoshan.com",
    xlsxUrl: "/manus-storage/annawawe_6c72435e.xlsx",
  },
  {
    id: "almuhalla",
    num: 8,
    ...
    xlsxUrl: "/manus-storage/almuhalla_158ef884.xlsx",
  },
  {
    id: "almughni",
    num: 9,
    ...
    stats: [
      { label: "كلمة", value: "1.8 مليون" },
      { label: "عبارة", value: "37,985" },
      { label: "علم", value: "30,586" },
      { label: "كتاباً", value: "70" },
    ],
    tag: "فقه حنبلي مقارن",
    url: "https://marqoom9.dralhoshan.com",
    xlsxUrl: "/manus-storage/almughni_7cd7a76d.xlsx",
  },
  {
    id: "albadaei",
    num: 10,
    ...
    stats: [
      ...
      { label: "علم", value: "12,356" },
    ],
    tag: "فقه حنفي تعليلي",
    url: "https://marqoom10.dralhoshan.com",
    xlsxUrl: "/manus-storage/albadaei_4b469872.xlsx",
  },
  ...
  },
  {
    id: "risala_legacy",
    num: 14,
    title: "كشّاف الرسالة والأم للشافعي [نسخة قديمة مدمجة مؤقتة]",
    author: "الإمام محمد بن إدريس الشافعي",
    death: "ت 204هـ",
    category: "فقه",
    categoryLabel: "الفقه المقارن",
    description:
      "[نسخة مدمجة مؤقتة — v1.0.0] فهرس تحليلي رقمي للرسالة والأم مدمجَين في كشاف واحد. سيُستبدل بكشافين مستقلين عند اكتمال إنتاج كشاف الأم بالبروتوكول v2.2.",
    stats: [
      { label: "كلمة", value: "1.2 مليون+" },
      { label: "عبارة", value: "48,967" },
      { label: "مقطع", value: "2,528" },
      { label: "مصنَّف", value: "2" },
    ],
    tag: "أصول فقه وفقه شافعي — نسخة مؤقتة",
  ...
  },
  {
    id: "risala",
    num: 14.1,
    title: "كشّاف الرسالة للشافعي",
    author: "الإمام محمد بن إدريس الشافعي",
    death: "ت 204هـ",
    category: "أصول",
    categoryLabel: "الأصول والمنطق",
    description:
      "فهرس تحليلي رقمي للرسالة — أول كتاب في أصول الفقه، يرصد 48,083 كلمة و2,152 عبارة منهجية و1,303 علماً و206 مصادر و114 مدرسة وتوجهاً. يكشف الطابع الأصولي الحواري الجدلي للإمام الشافعي.",
    stats: [
      { label: "كلمة", value: "48,083" },
      { label: "عبارة", value: "2,152" },
      { label: "علماً", value: "1,303" },
      { label: "مصدراً", value: "206" },
    ],
    tag: "أصول فقه — الرسالة",
    url: "https://marqoom14.dralhoshan.com",
  },
  {
    id: "umm_shafii",
    num: 14.2,
    title: "كشّاف الأم للشافعي",
    author: "الإمام محمد بن إدريس الشافعي",
    death: "ت 204هـ",
    category: "فقه",
    categoryLabel: "الفقه المقارن",
    description:
      "فهرس تحليلي رقمي للأم — الموسوعة الفقهية الشافعية الكبرى، يرصد 1,188,239 كلمة في 2,233 مقطعاً مع 46,815 عبارة منهجية و 27,070 علماً و 1,115 مصدراً و 1,529 مدرسة وتوجهاً. يكشف الطابع الفقهي التطبيقي للإمام الشافعي.",
    stats: [
      { label: "كلمة", value: "1.2م+" },
      { label: "عبارة", value: "46,815" },
      { label: "علماً", value: "27,070" },
      { label: "مصدراً", value: "1,115" },
    ],
    tag: "فقه شافعي — الأم",
    url: "https://marqoom14.dralhoshan.com",
    xlsxUrl: "/manus-storage/umm_shafii_c4f7a3dd.xlsx",
  },
  {
    id: "mustasfa",
    num: 15,
  ...
  },
  {
    ...
    stats: [
      { label: "عبارة", value: "91,777" },
      { label: "مورد", value: "48,424" },
      { label: "علم", value: "29,503" },
      { label: "كتاب مصدر", value: "7,712" },
    ],
    tag: "عقيدة وفقه وأصول",
    url: "https://marqoom75.dralhoshan.com",
    xlsxUrl: "/manus-storage/majmoo_fatawa_69ca772c.xlsx",
  },
  {
  ...
  },
  {
    ...
    stats: [
      { label: "صفحة", value: "11,890" },
      { label: "كلمة", value: "3.4 مليون" },
      { label: "علم", value: "20" },
      { label: "غرض", value: "6" },
    ],
  ...
  },
  {
    ...
    stats: [
      { label: "عبارة", value: "21,469" },
      { label: "مورد", value: "6,327" },
      { label: "علم", value: "2,685" },
      { label: "كلمة", value: "673,017" },
    ],
    tag: "عقيدة وفلسفة ونقد",
    url: "https://marqoom78.dralhoshan.com",
    xlsxUrl: "/manus-storage/dara_taarus_eafd2504.xlsx",
  },
  {
    ...
    stats: [
      { label: "صفحة", value: "5,150" },
      { label: "كلمة", value: "2.0 مليون" },
      { label: "علم", value: "20" },
      { label: "غرض", value: "10" },
    ],
    tag: "فقه حنفي مقارن",
  ...
  },
  {
    ...
    stats: [
      { label: "صفحة", value: "11,009" },
      { label: "كلمة", value: "2.9 مليون" },
      { label: "سورة", value: "114" },
      { label: "غرض", value: "8" },
    ],
  ...
  },
  {
    ...
    stats: [
      { label: "كلمة", value: "180,592" },
      { label: "صفحة", value: "863" },
      { label: "وحدة", value: "199" },
      { label: "مورد", value: "74" },
    ],
    tag: "بلاغة وأدب",
  ...
  },
  {
    ...
    stats: [
      { label: "كلمة", value: "1.6 مليون" },
      { label: "صفحة", value: "5,053" },
      { label: "سورة", value: "114" },
      { label: "علم", value: "14,293" },
    ],
  ...
  },
  {
    ...
    stats: [
      { label: "عبارة", value: "219,792" },
      { label: "مجلداً", value: "11" },
      { label: "كلمة", value: "2.5 مليون" },
      { label: "وحدة", value: "11,793" },
    ],
  ...
  },
  {
    ...
    category: "قرآن",
    categoryLabel: "علوم القرآن والقراءات",
    description: "فهرس تحليلي رقمي للزيادة والإحسان في علوم القرآن — 153 فصلاً، يرصد مسائل علوم القرآن من قراءات وتجويد وإعجاز وتفسير في هذه الموسوعة القرآنية الكبيرة.",
    stats: [
      { label: "فصلاً", value: "153" },
    ],
  ...
  },
  {
    ...
    category: "لغة",
    categoryLabel: "اللغة والبلاغة",
    description: "فهرس تحليلي رقمي لكتاب الأغاني — 2,697 مقالة، يرصد الشعراء والمغنين والأخبار والأنساب في هذه الموسوعة الأدبية الكبرى للتراث العربي.",
    stats: [
      { label: "مقالة", value: "2,697" },
    ],
    tag: "أدب وشعر وأخبار",
  ...
  },
  {
    ...
    description: "فهرس تحليلي رقمي لوفيات الأعيان وأنباء أبناء الزمان — 766,839 كلمة، 991 ترجمة، يرصد تراجم الأعلام والعلماء والأدباء والأمراء في هذه الموسوعة التراجمية الكبرى.",
    stats: [
      { label: "كلمة", value: "766,839" },
      { label: "ترجمة", value: "991" },
    ],
    tag: "تراجم وأعلام",
  ...
  },
  {
    ...
    category: "حديث",
    categoryLabel: "الحديث وعلومه",
    description: "فهرس تحليلي رقمي للتمهيد لما في الموطأ من المعاني والأسانيد — 142,329 عبارة منهجية، 5 أقسام، يرصد منهج ابن عبد البر في شرح الموطأ وتخريج الأحاديث.",
    stats: [
      { label: "عبارة", value: "142,329" },
      { label: "قسم", value: "5" },
    ],
  ...
  },
  {
    ...
    category: "حديث",
    categoryLabel: "الحديث وعلومه",
    description: "فهرس تحليلي رقمي للاستذكار الجامع لمذاهب فقهاء الأمصار — 85,648 عبارة منهجية، 50 كتاباً فقهياً، يرصد الخلاف الفقهي ومذاهب الأمصار في شرح الموطأ.",
    stats: [
      { label: "عبارة", value: "85,648" },
      { label: "كتاباً", value: "50" },
    ],
  ...
  },
  {
    ...
    category: "فقه",
    categoryLabel: "الفقه المقارن",
    description: "فهرس تحليلي رقمي للكافي في فقه أهل المدينة — 7,450 عبارة منهجية، يرصد الفقه المالكي وأقوال أهل المدينة في هذا المصنف الفقهي الجامع.",
    stats: [
      { label: "عبارة", value: "7,450" },
    ],
    tag: "فقه مالكي مدني",
  ...
  },
  {
    ...
    category: "عقيدة",
    categoryLabel: "العقيدة والأصول",
    description: "فهرس تحليلي رقمي لإعلام الموقعين عن رب العالمين — مليون كلمة تقريباً، 4 أجزاء، يرصد أصول الفتوى والاجتهاد والفقه المقاصدي في هذه الموسوعة الأصولية الكبرى.",
    stats: [
      { label: "كلمة", value: "1.0 مليون" },
      { label: "جزء", value: "4" },
    ],
  ...
  },
  {
    ...
    category: "عقيدة",
    categoryLabel: "العقيدة والأصول",
    description: "فهرس تحليلي رقمي لزاد المعاد في هدي خير العباد — 582,927 كلمة، 4 أجزاء، يرصد السيرة النبوية والفقه والطب والسلوك في هذه الموسوعة الجامعة.",
    stats: [
      { label: "كلمة", value: "582,927" },
      { label: "جزء", value: "4" },
    ],
    tag: "سيرة وفقه وسلوك",
  ...
  },
  {
    ...
    category: "عقيدة",
    categoryLabel: "العقيدة والأصول",
    description: "فهرس تحليلي رقمي لمدارج السالكين بين منازل إياك نعبد وإياك نستعين — 388,916 كلمة، 4 أجزاء، يرصد منازل السلوك والتزكية والمقامات في هذه الموسوعة الروحية.",
    stats: [
      { label: "كلمة", value: "388,916" },
      { label: "جزء", value: "4" },
    ],
  ...
  },
  {
    ...
    category: "عقيدة",
    categoryLabel: "العقيدة والأصول",
    description: "فهرس تحليلي رقمي للجواب الصحيح لمن بدل دين المسيح — 11,675 عبارة منهجية، 5,437 مورد، يرصد الرد على النصرانية ومنهج الجدل والاستدلال النقلي والعقلي.",
    stats: [
      { label: "عبارة", value: "11,675" },
      { label: "مورد", value: "5,437" },
      { label: "علم", value: "2,248" },
      { label: "كتاب مصدر", value: "1,276" },
    ],
  ...
  },
  {
    ...
    category: "عقيدة",
    categoryLabel: "العقيدة والأصول",
    description: "فهرس تحليلي رقمي لبيان تلبيس الجهمية في تأسيس بدعهم الكلامية — 20,254 عبارة منهجية، 11,995 مورد، يرصد الرد على الجهمية والمتكلمين ومنهج النقد العقدي.",
    stats: [
      { label: "عبارة", value: "20,254" },
      { label: "مورد", value: "11,995" },
      { label: "علم", value: "3,436" },
      { label: "كتاب مصدر", value: "1,051" },
    ],
...
const CATEGORIES = [
  { id: "all", label: "الكل", count: 98 },
  { id: "حديث", label: "الحديث وعلومه", count: 28 },
  { id: "قرآن", label: "علوم القرآن والقراءات", count: 4 },
  { id: "فقه", label: "الفقه المقارن", count: 15 },
  { id: "تفسير", label: "التفسير", count: 15 },
  { id: "عقيدة", label: "العقيدة والأصول", count: 19 },
  { id: "أصول", label: "الأصول والمنطق", count: 6 },
  { id: "لغة", label: "اللغة والبلاغة", count: 5 },
  { id: "سيرة", label: "السيرة والتاريخ", count: 5 },
  { id: "تراجم", label: "التراجم والأعلام", count: 3 },
];
...
function parseNum(v: string): number {
  ...
  if (clean.endsWith("مليون")) return Math.round(parseFloat(clean.replace("مليون", "")) * 1_000_000);
