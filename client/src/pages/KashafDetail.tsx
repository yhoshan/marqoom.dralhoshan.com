...
const KASHAFAT: KashafItem[] = [
  ...
  },
  {
    ...
    category: "فقه",
    categoryLabel: "الفقه المقارن",
    description: "[نسخة مدمجة مؤقتة — v1.0.0] فهرس تحليلي رقمي للرسالة والأم مدمجَين في كشاف واحد. سيُستبدل بكشافين مستقلين عند اكتمال إنتاج كشاف الأم بالبروتوكول v2.2.",
    longDesc: "هذه نسخة مدمجة مؤقتة تجمع الرسالة والأم في كشاف واحد ببروتوكول v1.0.0. ستُستبدل هذه النسخة بكشافين مستقلين بالبروتوكول v2.2 عند اكتمال إنتاج كشاف الأم.",
    stats: [
  ...
  },
  {
    ...
    description: "فهرس تحليلي رقمي للرسالة — أول كتاب في أصول الفقه، يرصد 48,083 كلمة و2,152 عبارة منهجية و1,303 علماً و206 مصادر و114 مدرسة وتوجهاً. يكشف الطابع الأصولي الحواري الجدلي للإمام الشافعي.",
    longDesc: "الإمام الشافعي (ت204هـ) مؤسس علم أصول الفقه. الرسالة أول كتاب في التاريخ يضع أصول الفقه بشكل منهجي متكامل. يرصد هذا الكشّاف 48,083 كلمة في 295 مقطعاً، مع 2,152 عبارة منهجية و206 مصدراً ومرجعاً و1,303 علماً و114 مدرسة وتوجهاً.",
    stats: [
      { label: "كلمة", value: "48,083", raw: 48083 },
      { label: "عبارة", value: "2,152", raw: 2152 },
      { label: "علماً", value: "1,303", raw: 1303 },
      { label: "مصدراً", value: "206", raw: 206 },
    ],
    chartData: [
      { label: "الاستدلال والتعليل", pct: 40 },
      { label: "الجدل والحوار", pct: 28 },
      { label: "الخلاف والترجيح", pct: 18 },
      { label: "الأدلة الشرعية", pct: 10 },
      { label: "التعريف والتقسيم", pct: 4 },
    ],
  ...
  },
  {
    ...
    category: "فقه",
    categoryLabel: "الفقه المقارن",
    description: "فهرس تحليلي رقمي للأم — الموسوعة الفقهية الشافعية الكبرى، يرصد 1,188,239 كلمة في 2,233 مقطعاً مع 46,815 عبارة منهجية و 27,070 علماً و 1,115 مصدراً و 1,529 مدرسة وتوجهاً. يكشف الطابع الفقهي التطبيقي للإمام الشافعي.",
    longDesc: "الإمام الشافعي (ت204هـ) مؤسس علم أصول الفقه. الأم موسوعته الفقهية الكبرى في الفقه التطبيقي. يرصد هذا الكشّاف 1,188,239 كلمة في 2,233 مقطعاً، مع 46,815 عبارة منهجية و 27,070 علماً و 1,115 مصدراً ومرجعاً و 1,529 مدرسة وتوجهاً.",
    stats: [
      { label: "كلمة", value: "1,188,239", raw: 1188239 },
      { label: "عبارة", value: "46,815", raw: 46815 },
      { label: "علماً", value: "27,070", raw: 27070 },
      { label: "مصدراً", value: "1,115", raw: 1115 },
    ],
    chartData: [
      { label: "الجدل والحوار", pct: 35 },
      { label: "الخلاف والترجيح", pct: 28 },
      { label: "النقل والرواية", pct: 20 },
      { label: "الاستدلال", pct: 11 },
      { label: "النقد والحكم", pct: 6 },
    ],
    tag: "فقه شافعي — الأم",
    url: "https://marqoom14.dralhoshan.com",
