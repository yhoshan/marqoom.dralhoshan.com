...
const KASHAFAT: KashafItem[] = [
  ...
  },
  {
    ...
    category: "حديث",
    categoryLabel: "الحديث وعلومه",
    description: "كشاف شامل لثلاثة مصنفات كبرى: التمهيد لما في الموطأ، والاستذكار، والكافي — يرصد منهج الإمام الحافظ في الحديث والفقه والرجال.",
    longDesc: "ابن عبد البر القرطبي (ت463هـ) إمام المحدثين في الغرب الإسلامي، جمع هذا الكشاف ثلاثة مصنفاته الكبرى: التمهيد لما في الموطأ من المعاني والأسانيد، والاستذكار الجامع لمذاهب فقهاء الأمصار، والكافي في فقه أهل المدينة. يرصد الكشاف منهج الإمام في الحديث والفقه المقارن وعلم الرجال.",
    stats: [
      { label: "كلمة", value: "8.5 مليون", raw: 8500000 },
