...
SCHEMA_REGISTRY = {
    ...
    "modules": {
        "ملخص تنفيذي": {
            "aliases": ["الملخص التنفيذي", "نتائج قابلة للنشر", "نتائج للنشر", "نتائج النشر", "مخرجات نشر"],
            "json_key": "executive_summary",
        },
        "المصطلحات المنهجية": {
            "aliases": ["المصطلحات", "مصطلحات منهجية"],
            "json_key": "terms",
        },
        "الكتب المصرح بها": {
            "aliases": ["الكتب", "كتب الموارد", "الموارد-الكتب", "كثافة الكتب"],
            "json_key": "books",
        },
        "الأعلام": {
        ...
        "المدارس والاتجاهات": {
            "aliases": ["المدارس", "المدارس والجهات العلمية"],
            "json_key": "schools",
        },
        "صيغ الأداء والرواية": {
        ...
        "الخلاف والترجيح": {
            "aliases": ["الخلاف والترجيح والنقد", "الخلاف", "الترجيح", "النقد"],
