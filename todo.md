...
## جلسة 2026-06-28 — تصحيح العناوين وتقسيم الكشافات المجمّعة

### المطلوب
- [x] حذف "بالأرقام" من جميع العناوين (فتح الباري + ابن تيمية)
- [x] تغيير عنوان كشاف ابن تيمية المجمّع — تم حذف الكشاف المجمّع كلياً وإبقاء المنفصلة (97-98)
- [x] حذف "كشّاف ابن تيمية بالأرقام" المجمّع (id: ibntimiah) من Home.tsx وKashafDetail.tsx
- [x] تغيير عنوان كشاف ابن عبد البر المجمّع — تم حذف الكشاف المجمّع كلياً وإبقاء المنفصلة (91-93)
- [x] حذف "كشّاف كتب ابن القيم الثلاثة" المجمّع وإبقاء الكشافات المنفصلة (94-96)
- [x] حذف "كشّاف ابن عبد البر" المجمّع وإبقاء الكشافات المنفصلة (91-93)
- [ ] مراجعة عناوين الكشافات التي تحتاج تصحيح لتكون باسم الكتاب لا المؤلف (بانتظار مراجعة صاحب المشروع)
- [x] إعداد قائمة الكشافات التي تحتاج تحديث بالبروتوكول الجديد v2.2 (محفوظة في PROTOCOL_UPDATE_LIST.md)

## جلسة 2026-06-28 — محرك استخراج الجداول الشامل

- [ ] فحص view_cache لعينة من الكشافات لاستخراج جميع أنماط الحقول الموجودة
- [ ] بناء محرك استخراج ذكي في getV22Tabs يتعامل مع أي بنية v2.2 تلقائياً
- [ ] اختبار المحرك على عدة كشافات والتحقق من ظهور الجداول
- [ ] حفظ checkpoint ورفع على GitHub
