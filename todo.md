...
- [ ] تغيير عنوان "كشّاف ابن تيمية بالأرقام" → "كشّاف الدرء والجواب والبيان لابن تيمية" (مؤقت ريثما يُقسَّم)
- [x] حذف "كشّاف ابن تيمية بالأرقام" المجمّع (id: ibntimiah) من Home.tsx وKashafDetail.tsx
- [ ] تغيير عنوان "كشّاف ابن عبد البر" → "كشّاف التمهيد والاستذكار والاستيعاب لابن عبد البر" (مؤقت ريثما يُقسَّم)
...
- [ ] تصحيح العناوين لتكون باسم الكتاب لا المؤلف حيثما ينطبق
