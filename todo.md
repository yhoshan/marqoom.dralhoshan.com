...
- [ ] فحص بنية ملفات Excel وتحديد الأوراق والأعمدة المشتركة
- [ ] بناء سكريبت ETL شامل لتحويل Excel إلى view_cache.json
- [ ] توليد view_cache.json لجميع الكشافات الـ 36
- [ ] ربط كل كشاف بملف JSON عبر قاعدة البيانات
- [ ] التحقق من عمل الكشافات المربوطة في المنصة

## خط الإنتاج المعياري (Excel → ETL → مرقوم)
- [ ] إنشاء MARQOOM_SCHEMA.md (مرجع البنية الرسمية لـ view_cache.json)
- [ ] إنشاء MARQOOM_PROTOCOL.md (بروتوكول خط الإنتاج الكامل)
- [ ] بناء etl/marqoom_etl.py الرسمي (يولّد view_cache.json + validation_report.json)
- [ ] اختبار ETL على كشاف البحر المحيط والتحقق من الامتثال 100%
- [ ] تحديث register_viewcache.mjs ليستخدم مخرجات ETL مباشرة
- [ ] توثيق خط الإنتاج في README
